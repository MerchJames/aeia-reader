...
import {
  VIEW_GROUP, VIEW_HINT, VIEW_LABEL, VIEW_ORDER, defaultVisibleViews, moveView, overflowViews,
  resolveVisibleViews, sanitizeVisibleViews, toggleView,
} from './viewBar';
...
ok(VIEW_ORDER.length === 9, 'all nine views are catalogued');
